            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Text("You're saving total ",
                          style: TextStyle(fontSize: 14)),
                      Text("₹100 ",
                          style: TextStyle(
                              fontSize: 14, fontWeight: FontWeight.bold)),
                      Text("on this order!", style: TextStyle(fontSize: 14)),
                      SizedBox(width: 4),
                ...
                // Other sections like Adfix Cover, Membership, Contact Info, Service Preferences, etc.
                // Define other sections similarly as separate widgets or here inline for brevity
...
// Tip Section
                ...
                // Additional sections like cancellation policy, tip, etc., if needed.
              ],
            ),
          )),
