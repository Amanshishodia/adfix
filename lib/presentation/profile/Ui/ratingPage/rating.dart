                ...
                children: [
                  ...
                  children: [
                    Align(
                      ...
                      child: Icon(Icons.handshake, size: 40, color: Colors.blue), // Placeholder icon
                    ),
                  ...
                  children: [
                    Align(
                      alignment: Alignment.topLeft,
                      child: Icon(Icons.support_agent, size: 40, color: Colors.red), // Placeholder icon
                    ),
                    SizedBox(height: 12.0),
                    Align(
                      alignment: Alignment.topLeft,
                  ...
                  children: [
                    Align(
                      alignment: Alignment.topLeft,
                      child: Icon(Icons.message_outlined, size: 40, color: Colors.green), // Placeholder icon
                    ),
                    SizedBox(height: 12.0),
                    Align(
                      alignment: Alignment.topLeft,
